        ...
        <a>
          ...
          <div class="shop_right">
            <section class="shop_detail_header">
              <h4 class="shop_title ellipsis" v-text="shop.name"></h4>
              <ul class="shop_detail_ul">
                <li
                  class="supports"
                  v-for="(support, index) in shop.supports"
                  :key="index"
                  v-text="support.icon_name"
                ></li>
              </ul>
            </section>
            <section class="shop_rating_order">
              <section class="shop_rating_order_left">
                ...
                <div class="order_section">
                  月售
                  <span v-text="shop.recent_order_num"></span> 单
                </div>
              </section>
              <section class="shop_rating_order_right">
                <span class="delivery_style delivery_right" v-text="shop.delivery_mode.text"></span>
              </section>
            </section>
            <section class="shop_distance">
              <p class="shop_delivery_msg">
                <span>
                  <span v-text="shop.float_minimum_order_amount"></span>起送
                </span>
                <span class="segmentation">/</span>
                <span v-text="shop.piecewise_agent_fee.tips"></span>
              </p>
            </section>
          </div>
        </a>
...
export default {
  ...
  mounted() {
    this.$store.dispatch("receiveShoplist");
  },
  computed: {
    ...mapState(["shopList"])
  },
